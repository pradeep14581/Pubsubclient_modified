...
void setup() {
  pinMode(BUILTIN_LED, OUTPUT);     // Initia  lize the BUILTIN_LED pin as an output
  Serial.begin(115200);
  setup_wifi();
}
...
void loop() {
  ...
  if (now - lastMsg > 2000) {
    ...
    if (client.connected()) {
        ...
        Serial.println(msg);
      //  client.publish("outTopic_QOS0", msg);
        client.publish("outTopic2", "hello world", MQTTpubQos, true);
        //client.publish("outTopic1", "hello world", 1, true);
    }
  }
}
